        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=1000640531" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-accent transition-colors" aria-label="Facebook">
                <Facebook />
              </a>
              <a href="https://www.instagram.com/bigmanbarbershopp" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-accent transition-colors" aria-label="Instagram">
                <Instagram />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-slate-400 hover:text-accent transition-colors">
                Corte de Cabelo
              </li>
              <li className="text-slate-400 hover:text-accent transition-colors">
                Barba
