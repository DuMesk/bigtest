...
import { ShoppingCart, Filter, ChevronDown, Check, X } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <img 
          src="https://images.pexels.com/photos/996329/pexels-photo-996329.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" 
          alt="Loja BIG MAN" 
          className="absolute w-full h-full object-cover object-center"
        />
        <div className="container-custom relative z-20 text-white">
          <h1 className="heading-xl mb-6">Linha de Roupas BIG MAN</h1>
          <p className="text-xl text-white/80 max-w-3xl">
            Vista-se com estilo! Conheça nossa linha exclusiva de roupas masculinas com a qualidade e design únicos da BIG MAN Barber.
          </p>
        </div>
      </section>
